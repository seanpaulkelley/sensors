...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { sensor_type: @reading.sensor_type, value: @reading.value } }, as: :json
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { sensor_type: @reading.sensor_type, value: @reading.value } }, as: :json
    assert_response 200
  end
